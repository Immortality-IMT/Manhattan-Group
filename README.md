...
```We suggest doubling the miner's block reward and transaction fee to fund deSci. The extra miner's block reward come with a restriction, it must be donated to watershed technologies.```
